...
def _process_class(cls: type, context_frame, config: Configuration, check_types, **kw):
    ...
    if init_f:
        try:
            del c.__init__  # type: ignore[misc]
        except AttributeError:
            pass
    ...
    if check_types:
        ...
        c.__post_init__ = __post_init__  # type: ignore[attr-defined]
        ...
        if not kw["frozen"]:
            ...
            c.__setattr__ = __setattr__  # type: ignore[method-assign, assignment]
    else:
    ...
    if init_dispatcher:
        ...
        if hasattr(c, "__init__"):
            ...
            c.__init__ = init_dispatcher(_fix_qualname(c.__init__, cls))  # type: ignore[misc]
        else:
            c.__init__ = init_f  # type: ignore[misc]
    return c
...
class _Dataclass:
    ...
    @dataclass_transform(field_specifiers=(dataclasses.field, dataclasses.Field), frozen_default=True)  # type: ignore[misc]
    def __call__(
        self,
        ...
        *,
        ...
        this = dataclasses.replace(self, **new_options) if new_options else self  # type: ignore[arg-type]
...
def dataclass(
    ...
    *,
    ...
    unsafe_hash: bool = False,
    frozen: bool = True,
    slots: bool = ...,  # type: ignore[assignment]  # `...` sentinel: "use the default slots behavior"
) -> Union[type, "_Dataclass"]:
